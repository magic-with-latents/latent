...
::: {.g-col-12  .g-col-sm-12 .g-col-md-4}
 <figure>
  ...
  <label for="nain">Senior Data Scientist at [H2O](https://h2o.ai/). One of the maintainers of the TensorFlow-addons package, Google Developers Expert in Machine Learning, and JAX. Actively contributes to Keras, TensorFlow, and JAX.</label>
</figure> 
:::
